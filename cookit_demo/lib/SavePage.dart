...
class _SavePage extends State<SavePage> {
  ...
  Widget appBarTitle =
      new Text('Bookmarks', style: TextStyle(color: Colors.lightGreen));
                ...
                builder: (context, snapshot) {
                  ...
                  switch (snapshot.connectionState) {
                    ...
                    default:
                      if (!snapshot.hasData) {
                      ...
                      } else if (snapshot.data['saved'].length == null ||
                          snapshot.data['saved'].length == 0) {
                        return Container(
                            alignment: FractionalOffset.center,
                        ...
                        return new ListView(
                          ...
                          children: List.generate(snapshot.data['saved'].length,
                              (index) {
                            //print(snapshot.data['favorites'][index]);
                            List temp3 = [];
                            if (!temp3.contains(
                                snapshot.data['saved'][index].toString())) {
                              temp3.add(
                                  snapshot.data['saved'][index].toString());
                            }
