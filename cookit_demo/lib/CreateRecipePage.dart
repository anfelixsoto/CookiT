...
class _CreateRecipe extends State<CreateRecipe> {
            ...
            child: TextFormField(
              decoration: InputDecoration(
                  ...
                  focusedBorder: UnderlineInputBorder(
                      borderSide: BorderSide(color: Colors.lightGreen))),
              validator: (value) =>
                  value.isEmpty ? 'Recipe name can\'t be empty' : null,
              onChanged: (value) {
                if (value.length > 0) {
                  _recipeName = value;
                }
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                  ...
                  focusedBorder: UnderlineInputBorder(
                      borderSide: BorderSide(color: Colors.lightGreen))),
              validator: (value) =>
                  value.isEmpty ? 'Prep time can\'t be empty' : null,
              onChanged: (value) {
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                  ...
                  focusedBorder: UnderlineInputBorder(
                      borderSide: BorderSide(color: Colors.lightGreen))),
              validator: (value) =>
                  value.isEmpty ? 'Calories can\'t be empty' : null,
              onChanged: (value) {
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                  ...
                  focusedBorder: UnderlineInputBorder(
                      borderSide: BorderSide(color: Colors.lightGreen))),
              validator: (value) =>
                  value.isEmpty ? 'Servings can\'t be empty' : null,
              onChanged: (value) {
  ...
  Widget showIngredients() {
    return Card(
      child: ExpansionTile(
        title: Text("Ingredients (" + _countIngredients.toString() + ")",
            style: TextStyle(color: Colors.lightGreen)),
        trailing: IconButton(
            icon: Icon(Icons.add),
  ...
  Widget showInstructions() {
    return Card(
      child: ExpansionTile(
        title: Text("Instructions (" + _countInstructions.toString() + ")",
            style: TextStyle(color: Colors.lightGreen)),
        trailing: IconButton(
            icon: Icon(Icons.add),
