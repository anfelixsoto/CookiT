                                ...
                                Container(
                                  ...
                                  child: ListView.builder(
                                      ...
                                      itemBuilder: (context, index) {
                                        return new Card(
                                          child: new ListTile(
                                              leading: Icon( Icons.add_circle_outline, size: 17, color: Colors.lightGreen),
                                              title: Text((recipe.ingredients[index]),style: TextStyle(fontSize: 17.0, color: Colors.grey))
                                          ),
                                        );
                                      }
                                  ),
