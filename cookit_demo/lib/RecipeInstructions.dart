...
class RecipeInstructions extends StatelessWidget {
  ...
  final Recipe rId;
  final RecipeId dbId;
  RecipeInstructions({Key key, @required this.recipe, this.rId, this.dbId})
      : super(key: key);
                          ...
                          children: <Widget>[
                            ...
                            Card(
                              child: ExpansionTile(
                                title: Text(
                                    "Instructions (" +
                                        recipe.instructions.length.toString() +
                                        ")",
                                    style: TextStyle(
                                      fontWeight: FontWeight.w400,
                                      fontSize: 20.0,
...
//                                  child:Text(
//                                      "Instructions (" + recipe.instructions.length.toString() + ")",
//                                      style: TextStyle(
//                                        fontWeight: FontWeight.w400,
//                                        fontSize: 20.0,)
//                                  ),
