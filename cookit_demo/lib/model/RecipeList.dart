...
class RecipeList{
  ...
  static Future<RecipeList> fetchRecipes(List<String> ingredients) async {
    ...
    final response =
      await http.get('https://api.spoonacular.com/recipes/findByIngredients?ingredients='+url+'&ranking=2&number=5&ignorePantry=true&apiKey=1fcbb82f69a7495a8ec32f7c507f832d');
